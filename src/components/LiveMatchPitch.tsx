...
export default function LiveMatchPitch({momentum,homeColor,awayColor,playerIsHome,minute}:{momentum:number;homeColor:string;awayColor:string;playerIsHome:boolean;minute:number}){
