...
export const COMPETITION_DEFINITIONS: Record<string, CompetitionDefinition> = {
  ...
  youthShowcase: { id: 'youthShowcase', name: 'Youth Showcase', format: 'friendly', category: 'selection', level: 'national', prestige: 68, eligibility: { minAge: 14, maxAge: 18, requiresInjuryClearance: true }, yellowCardsForBan: 3 },
  ...
  academyTrials: { id: 'academyTrials', name: 'Academy Trials', format: 'selection', category: 'selection', level: 'regional', prestige: 55, eligibility: { minAge: 14, maxAge: 19, requiresInjuryClearance: true }, yellowCardsForBan: 3 },
}
